...
```bash
cd deestincts # from the root of the repo
```
...
> [!TIP]
> You can also use the Vercel CLI for deployment. Install it globally with `npm i -g vercel`, then run `vercel` in your deestincts directory and follow the prompts.
> [!NOTE]
