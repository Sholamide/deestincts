...
//             <Image src="/marquee/florence.png" alt="florence" width={200} height={64} className="h-16 md:h-20 w-auto object-contain filter grayscale opacity-70 hover:opacity-100 transition-opacity duration-300 mx-6 md:mx-8" />
...
//             <Image src="/marquee/oosha.svg" alt="oosha" width={200} height={64} className="h-16 md:h-20 w-auto object-contain filter grayscale opacity-70 hover:opacity-100 transition-opacity duration-300 mx-6 md:mx-8" />
