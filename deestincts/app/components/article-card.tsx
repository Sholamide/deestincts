...
//         <Link
//           href={`/articles/${slug}`}
//           className="inline-flex items-center gap-1 text-sm font-medium text-[#8c8c8c] group-hover:translate-x-2 transition-transform duration-300 hover:text-[#8c8c8c]/80"
//         >
//           Read More
  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: "200px" }} // Fixed height for image section
      >
        <SanityImage
          image={coverImage}
          alt={title}
      ...
      <div
        ...
        style={{ height: "250px" }} // Fixed height for content section
      >
        <div>
          <h3
            className="text-xl text-white mb-3 group-hover:text-gray-600 transition-colors duration-300 line-clamp-2"
            style={{ height: "50px" }} // Fixed height for title
          >
            {title}
          </h3>
          <p
            className="mb-4 text-sm text-white/70 line-clamp-3"
            style={{ height: "60px" }} // Fixed height for excerpt
          >
            {excerpt}
          </p>
          <div
            className="mb-4 flex items-center gap-2"
            style={{ height: "40px" }} // Fixed height for author info
          >
            <div className="h-8 w-8 overflow-hidden rounded-full">
              <SanityImage
                image={authorImage}
